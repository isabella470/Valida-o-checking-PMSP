...
if link_planilha1 and planilha2_file:
    ...
    if url_csv is None:
        ...
        with st.spinner("Lendo Planilha 1..."):
            ...
            # Pré-processar colunas de hora
            df1[col_hora_1] = df1[col_hora_1].apply(zerar_segundos)
            df2[col_hora_2] = df2[col_hora_2].apply(zerar_segundos)

            # Padronizar strings para comparação case-insensitive
            df1[col_veiculo_1] = df1[col_veiculo_1].astype(str).str.strip().str.lower()
            df2[col_veiculo_2] = df2[col_veiculo_2].astype(str).str.strip().str.lower()
            df1[col_titulo_1] = df1[col_titulo_1].astype(str).str.strip().str.lower()
            df2[col_titulo_2] = df2[col_titulo_2].astype(str).str.strip().str.lower()
            ...
            with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
                ...
                # Congelar cabeçalho e aplicar filtro
